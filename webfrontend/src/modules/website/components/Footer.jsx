  ...
  return (
    <>
      <style>{`
        ...
        /* Mobile: links row — 2 cols side by side */
      ...
      <footer style={{ background: 'linear-gradient(160deg,#0B1E4B 0%,#0d2258 50%,#0B1E4B 100%)' }}>
        ...
        >
          {/*
            Mobile:  Brand full width, then links-row (2-col), then contact full width
            sm:      2-col grid
            lg:      4-col grid
          */}
          <div className="!grid !grid-cols-1 sm:!grid-cols-2 lg:!grid-cols-4 !gap-[28px] sm:!gap-[32px] lg:!gap-[40px]">
            ...
            <div className="sm:col-span-2 lg:!col-span-1">
              ...
              <p
                ...
                style={{ fontSize: 12.5, color: 'rgba(255,255,255,.55)', lineHeight: 1.75, maxWidth: 280 }}
              >
            ...
            {/* ── Col 2+3 — Quick Links + Info (2-col on mobile via CSS) ── */}
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,.08)' }}>
          ...
          >
            <p className="!m-0" style={{ fontSize: 11.5, color: 'rgba(255,255,255,.35)', fontWeight: 400 }}>
              © {new Date().getFullYear()} UDIISA NGO. All rights reserved.
            </p>
            <div className="!flex !items-center !gap-[6px]" style={{ fontSize: 11.5, color: 'rgba(255,255,255,.35)' }}>
              Made with <span style={{ color: '#F05A1A', fontSize: 12 }}>❤️</span> by UDIISA Web Team
            </div>
          </div>
        </div>
